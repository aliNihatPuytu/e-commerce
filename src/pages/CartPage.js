...
export default function CartPage() {
  ...
  const { allChecked, selectedTotal, totalCount, hasSelected } = useMemo(() => {
    ...
    return { allChecked, selectedTotal, totalCount, hasSelected };
  }, [cart]);
    ...
    <div className="w-full bg-white">
      <Container className="flex flex-col py-10">
        ...
        {cart.length === 0 ? (
          ...
          <>
            <div className="mt-8 w-full overflow-hidden rounded border border-[#E6E6E6]">
              ...
              <div className="border-t border-[#E6E6E6] bg-white px-4 py-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-lg font-bold text-[#252B42]">{fmt(selectedTotal)}</div>
                </div>
